                  ...
                  <TBODY>
                    ...
                    <TR vAlign=top> 
                      <TD height="8" bgcolor="#000000"> 
                        <div align="center">
                          <p><font color="#FFFFFF" size="3">查看新闻</font></p>
                          </div></TD>
                    </TR>
                    <TR vAlign=top> 
					...
					<table width="450" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff" align="center">
						...
						<tr>
						<td>
						<a href="<%=request.getContextPath()%>/show/news.jsp?page=<%=currentpage-1%>">上一页</a>
						<a href="<%=request.getContextPath()%>/show/news.jsp?page=<%=currentpage+1%>">下一页 </a>
						<a href="<%=request.getContextPath()%>/show/news.jsp?page=1">首页 </a>
						<a href="<%=request.getContextPath()%>/show/news.jsp?page=<%=totalpages%>">尾页 </a>
                        ...
                        <%	
     					...
     					%>
     					 ...
     					 <table width="550" height="175" border="0" align=center>
                            <tr align="center"> 
                              <td colspan="3"><font color="#990066"><b>标题 : <%=nmodel.getNewsTitle()%></b></font></td>
                          </tr>
                          <tr> 
                              
                            <td width="192" align="center"><strong>发表人 : <%=nmodel.getPromulgator()%></strong></td>
                            <td width="348"  align="center">发表时间: <%=nmodel.getSubmitime()%></td>
                          </tr>
                          <tr align="center"> 
