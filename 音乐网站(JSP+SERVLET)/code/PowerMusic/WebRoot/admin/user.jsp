                      ...
                      <table width="100" height="245" align="left">
					    ...
					    <table width="40%" height="23" border="0" align="center">
                          <tr> 
                            ...
                            <td width="28%"><a href="<%=request.getContextPath()%>/admin/admin.jsp?action=common">管理员</a></td>
                          </tr>
                        </table>
						<!--用户管理首页-->
                        <p></p>
                        ...
                        <%
						  ...
						  <tr bgcolor="#cccccc">
							...
							<td align="center" nowrap width="15%"><b>用户名</b></td>
							<td align="center" nowrap width="15%"><b>密码</b></td>
							<td align="center" nowrap width="17%"><b>E-Mail</b></td>
							<td align="center" nowrap width="8%"><b>性别</b></td>
							<td align="center" nowrap width="10%"><b>QQ</b></td>
							<td align="center" nowrap width="11%"><b>角色</b></td>
							<td align="center" nowrap width="15%"><b>注册时间</b></td>
							 <% 
						   ...
						   %><TR bgcolor="#6600CC">
						        ...
						        <%if(umodel.getUserRule()==0){
						        	out.print("普通用户");}else{out.print("管理员");}%></td>
						...
						<tr>
						<td>
						<a href="<%=request.getContextPath()%>/admin/user.jsp?action=common&page=<%=currentpage-1%>">上一页</a>
						<a href="<%=request.getContextPath()%>/admin/user.jsp?action=common&page=<%=currentpage+1%>">下一页 </a>
						<a href="<%=request.getContextPath()%>/admin/user.jsp?action=common&page=1">首页 </a>
						<a href="<%=request.getContextPath()%>/admin/user.jsp?action=common&page=<%=totalpages%>">尾页 </a>
                        ...
                        <table width="40%" border="0" align="center">
                        <TR><td colspan=2 align="center">搜索用户</td>
                        </TR>
                          <tr> 
                            <td width="19%">用户名</td>
