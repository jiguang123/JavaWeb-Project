...
function recom()
 {
    ...
    document.form1.position.value="00";
    document.form1.submit();
 } 
//tejiashangpin 
function recom1()
 {
    document.form1.par.value="recommand";
    document.form1.position.value="04";
    document.form1.submit();
 }  
...
<%
       ...
       if(par!=null&&par.equals("recommand"))
        {
           ManageCommandGoods.updateFirstRecommand();           
     ...
     com_vct = ManageCommandGoods.getCommandGoodsSList("04");//首页特价商品        
     com1_vct = ManageCommandGoods.getFirstCommandGoodsSList("00","");//首页商品
...
<input type="hidden" name="position" value="00">
...
<table align=center border=1 bordercolor=#095ab5 
                ...
                <tr valign=center BGCOLOR="#D0ECF9"> 
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="8"><B><FONT SIZE="2">&nbsp;特价产品</FONT></B></td>
                </tr>
                <tbody>
                  <tr valign=center> 
                    ...
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=3>取消推荐</td>
                  </tr>                      
        ...
        {         
           ...
           %>
                  <tr valign=center> 
                    ...
                    <td align=left height=25 valign=MIDDLE 
                        width="15%" colspan=1><font color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;特价产品</font></td>                                            
                 
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=3><input type="checkbox" name="recomid1" value="<%=t_vct.get(0)%>" >取消推荐</input></td>
                  </tr>            
           <%
        }
    }
...
<table align=center border=1 bordercolor=#095ab5 
                  ...
                  id=submenu1 width="90%">
                <tr valign=center BGCOLOR="#D0ECF9"> 
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="8"><B><FONT SIZE="2">&nbsp;首页商品</FONT></B></td>
                </tr>
                <tbody>
                  <tr valign=center> 
                    <td align=left height=25 valign=MIDDLE 
        ...
        {         
           ...
           %>
                  <tr valign=center> 
                    ...
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=1><%=t_vct.get(2)%>--><%=t_vct.get(3)%></td>                                                 
                    <td align=left height=25 valign=MIDDLE 
                        width="15%" colspan=1><font color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;首页普通商品</font></td>                                            
...
<table align=center border=1 bordercolor=#095ab5 
                ...
                <tbody>
                  <tr valign=center> 
                    ...
                    <td align=left height=25 valign=MIDDLE 
                        width="15%" colspan=1><font color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;推荐类型</font></td>                                                               
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=3>选择</td>
                  </tr>                      
 ...
 <td align=left height=25 valign=MIDDLE 
                    ...
                    <td align=left height=25 valign=MIDDLE 
                        ...
                        <font color="#000000">&nbsp;&nbsp;
                        <select name="type">
                        <option value="00">首页普通商品</option>
                        <option value="04">首页特价商品</option>
                        </select>

                        </font>
                        </td>    
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=3>
                     <input type="hidden" name="recomid" value="<%=t_vct.get(0)%>">
                    <input type="checkbox" name="recomnum" value="<%=i%>">选择</input>
                    </td>
                  </tr>            
           <%
        }
...
%>           
              ...
              <br> 
              <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="button" value="推荐" onclick="recom()"></input>&nbsp;&nbsp; <input type="button" value="取消推荐" onclick="recom1()"></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </p></td></tr> 
</table>
</td>
</tr> 
