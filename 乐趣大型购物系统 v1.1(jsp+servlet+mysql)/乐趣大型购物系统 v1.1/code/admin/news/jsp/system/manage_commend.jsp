...
function sub()
 {    
     document.form1.par.value="commend";
...
<%
       ...
       if(par!=null&&par.equals("commend"))
        {
            managecommend.updateCommendType();
        }
       ...
       //Vector m_vct = pageCtl.getcurData(managecommend.getNewList(),20,curpage);  //取新闻列表 
       Vector m_vct =managecommend.getNewList();  //取新闻列表 
...
<table align=center border=1 bordercolor=#095ab5 
                ...
                <tr valign=center BGCOLOR="#D0ECF9"> 
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="8"><B><FONT SIZE="2">&nbsp;焦点文章</FONT></B></td>
                </tr>
                <tbody>
                  <tr valign=center> 
...
<%
    Vector c_m_vct = managecommend.getNewCommendList("01");
   
%> 

<%
   if(c_m_vct!=null&&c_m_vct.size()>0)
    {
       for(int i=0;i<c_m_vct.size();i++)
        {
            Vector t_vct = (Vector)c_m_vct.get(i);
            %>
                  <tr valign=center> 
                    <td align=left height=25 valign=MIDDLE 
...
<table align=center border=1 bordercolor=#095ab5 
                  ...
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="" BGCOLOR="#D0ECF9" width="25%"><B><FONT SIZE="2">&nbsp;</FONT></B></td>
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="" width="25%">
                  <FONT SIZE="2">&nbsp;
                  <!--select name="status">
                ...
                <tbody>
                  <tr valign=center> 
                    ...
                    <td align=CENTER height=25 valign=MIDDLE 
                       ...
                       <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=1>作者</td>                        
                        <td align=CENTER height=25 valign=MIDDLE 
                        width="10%" colspan="2"><font color="#000000">推荐类型</font></td>
       ...
       for(int i=0;i<m_vct.size();i++)
        {
            ...
            %>
                  <tr valign=center> 
                   ...
                   <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=1><%=t_vct.get(2)%></td>     
                    <td align=CENTER height=25 valign=MIDDLE 
                        width="10%" colspan="2"><font color="#000000">&nbsp;<select ></font></td>
                    <td width="10%" height=25 align=CENTER valign=MIDDLE colspan=1><input type="checkbox" name="id" value="<%=t_vct.get(0)%>"></td>
                  </tr>               
            <%
        }
...
<table>					  
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;<input type="button" name="button_1" value="推荐" onclick="sub()">&nbsp;<!--input type="button" name="button_1" value="取消推荐" onclick="subdel()"-->&nbsp;&nbsp;</p></td></tr> 
