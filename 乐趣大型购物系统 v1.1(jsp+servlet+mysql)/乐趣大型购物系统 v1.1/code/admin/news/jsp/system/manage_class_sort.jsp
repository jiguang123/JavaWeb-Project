...
function sub()
 {
     if(document.form1.button_1.value=="更新")
      {
...
<%
       ...
       Vector m_vct = manageclass.getNewClass(); //取一级栏目 
...
<table align=center border=1 bordercolor=#095ab5 
                ...
                <tr valign=center BGCOLOR="#D0ECF9"> 
                  <td align=CENTER height=25 valign=MIDDLE COLSPAN="4"><B><FONT SIZE="2">&nbsp;</FONT></B></td>
                </tr>
                <tbody>
                  <tr valign=center> 
       ...
       for(int i=0;i<m_vct.size();i++)
        {
                 ...
                 <input type="hidden" name="id" value="<%=t_vct.get(0)%>"> 
                  <tr valign=center BGCOLOR="#D0ECF9"> 
                    ...
                    <td align=CENTER height=25 valign=MIDDLE 
                        width="10%" ><font color="#000000"><input type="text" value="<%=t_vct.get(2)%>" size="4" name="sort"></input></font></td>                        
                  </tr>  
                 <%
                Vector subclass_vct =  manageclass.getNewsSubClass(t_vct.get(0).toString());
                    ...
                    for(int j=0;j<subclass_vct.size();j++)
                     {
                        ...
                        <td align=CENTER height=25 valign=MIDDLE 
                        width="10%"><font color="#000000"><input type="text" value="<%=t1_vct.get(2)%>" size="4" name="sort"></input></font></td>                        
                        </tr>                         
                        <%
                     }   
                 } 
...
%>                    
                  ...
                  <tr valign=center> 
                    <td align=CENTER height=25 valign=MIDDLE colspan="5">
                    &nbsp;<input type="button" name="button_1" value="更新" onclick="sub()">
                    </td>
                  </tr>                  
