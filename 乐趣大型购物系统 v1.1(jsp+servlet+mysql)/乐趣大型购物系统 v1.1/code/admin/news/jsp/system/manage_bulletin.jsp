...
<%
       ...
       if(par!=null&&par.equals("del"))
        {
          managebulletin.deleteBulletin(aid);
        }       
            
        
       int curpage = request.getParameter("jumpPage")==null?1:Integer.parseInt(request.getParameter("jumpPage"));   
         
      // Vector m_vct = pageCtl.getcurData(managebulletin.getListBulletin(),10,curpage);  //取公告列表分页
       Vector m_vct = managebulletin.getListBulletin(); 
...
<table>					  
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;<input type="button" name="button_1" value="发布" onclick="sub()">&nbsp;<input type="button" name="button_1" value="删除" onclick="subdel()">&nbsp;&nbsp;</p></td></tr> 
</table></td></tr>
<!--form name="form1" method="post"> 
<input type="hidden" name="par"-->
<tr>
...
<table align=center border=1 bordercolor=#095ab5 
                  ...
                  <tr valign=center>
                  <td align=left height=25 valign=MIDDLE COLSPAN="1" BGCOLOR="#D0ECF9" width="25%"><B><FONT SIZE="2">有 效 期：</FONT></B></td>
