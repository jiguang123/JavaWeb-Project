...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="920" valign="top"><table width="610" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td valign="top"> <table width="600" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                            ...
                            <td width="100"> <div align="center"> 
                              <table width="66" border="0" cellpadding="0" cellspacing="0" bordercolor="#C99803" bordercolordark="#FFFBEC">
                                  <tr> 
                                    ...
                                    <div align="center">
                                             &nbsp;&nbsp;&nbsp;&nbsp;<a href="shopdetail.jsp?id=<%=t_vct.get(0)%>" target="_blank"><img src="../../<%=img_url%>" width="108" height="133" border="0"></a>
                                     </div>
                                   </td>
...
<%
       ...
       m_vct = shop.getGoodsList(boardID);      
                                 ...
                                 %>
                                     <tr> 
                                       <td width="300"> <table width="300" border="0" cellspacing="0" cellpadding="0">
                                           <tr> 
                                             <td width="150" height="153"> <div align="center"><a href="shopdetail.jsp?id=<%=t_vct.get(0)%>" target="_blank"><img src="../../<%=((Vector)img_vct.get(0)).get(1)%>" width="108" height="133" border="0"></a></div></td>
                                             <td width="150" height="153">
                                             <table width="150" border="0" cellspacing="0" cellpadding="0">
                                                 <tr> 
                                                   <td height="25"><font color="#0386B8" size="2"><strong><%=t_vct.get(1)%></strong></font></td>
