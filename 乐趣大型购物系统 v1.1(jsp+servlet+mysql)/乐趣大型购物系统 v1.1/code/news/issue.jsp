...
<form name="issueform" method="post">
                ...
                <input type=hidden name=par value="0"> 
                                ...
                                <tr> 
                                  <td width="110" height="30"> <div align="center">文章标题：</div></td>
                                  <td width="400" height="30"> <input type="text" name="title"></td>
                                </tr>
                                <tr> 
                                  <td width="110" height="30"> <div align="center">作 
                                      &nbsp;&nbsp; 者：</div></td>
                                  <td width="400" height="30"> <input type="text" name="author"  value="<%=nickname%>"></td>
                                </tr>
                                <tr> 
                                  <td width="110" height="30"> <div align="center">文章类型：</div></td>
                                  <td width="400" height="30"> 
                                  <select name="article_type">
                                      <option value="00">原创</option>
                                      <option value="01">转载</option>
                                    </select></td>
                                </tr>
                                <tr> 
                                  <td width="110" height="30"> <div align="center">摘 
                                      &nbsp;&nbsp; 自：</div></td>
                                  <td width="400" height="30"> <input type="text" name="pick"></td>
                                </tr>
                                <tr> 
                                  <td width="110"><div align="center">文章内容：</div></td>
                                  <td width="400"><textarea name="content" cols="50" rows="10"></textarea></td>
                                </tr>
                                <tr> 
                                  <td>&nbsp;</td>
                                  <td height="30"><div align="center"><a href="javascript:sub()"><img src="images/fabuwenzhang.jpg" width="84" height="17" border="0"></a></div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
      ...
      {    
         %>                                                                                
              <tr> 
                <td width=80% align="center" valign="center">&nbsp;<font color="red">请选择左面您要发表文章的分类</font></td>     
              </tr> 
         <%
      }
%>                                  
